...
describe('removes data', () => {
  it('clear queue in queue list', async () => {
    ...
    await page.click('text=Patient Name Clinic Name Clinic Address Clinic Phone Appointment Confirmation &  >> textarea')
    await page.fill('text=Patient Name Clinic Name Clinic Address Clinic Phone Appointment Confirmation &  >> textarea', 'dear ')
    await page.click('text=Patient Name')
    await page.click('text=Patient Name Clinic Name Clinic Address Clinic Phone Appointment Confirmation &  >> textarea')
    await page.fill(
      'text=Patient Name Clinic Name Clinic Address Clinic Phone Appointment Confirmation &  >> textarea',
