...
describe('removes data', () => {
    it('clear queue in queue list', async () => {
        ...
        let medServiceExists = await page.isVisible(`text=self-reg1`)
        ...
        if (medServiceExists === false) {
            ...
            await page.fill('input[type="text"]', 'self-reg1')
            ...
            await page.click('text=Medical Service self-reg1 Created Successfully')
        }
        ...
        await page3.click('text=Your registration has been saved.')
        ...
        await page.click('text=self-reg1')
        await page.click('button:has-text("Delete")')
        await page.click('[placeholder="self-reg1"]')
        await page.fill('[placeholder="self-reg1"]', 'self-reg1')
        await page.click('text=ok')
        await page.click('text=Medical Service self-reg1 Deleted Successfully')
    })
})
