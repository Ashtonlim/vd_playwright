...
describe('removes data', () => {
    it('clear queue in queue list', async () => {
        ...
        await page.isVisible(
            'text=2021 2021/05/27 16:41 PM Status: appointment.undefined Location: Location 1 User >> div'
        )
        await page.click('text=20 May 2021 $ 20')
        await page.isVisible(
            'text=2021 2021/05/20 15:43 PM Status: appointment. Location: Location 1 User: VD Supp >> div'
        )
        await page.isVisible(
            'text=2021 2021/05/20 12:19 PM Status: appointment.undefined Location: Location 1 User >> div'
        )
        ...
        await page.isVisible(
            'text=2021 2021/05/20 09:22 AM Status: appointment.undefined Location: Location 1 User >> div'
        )
