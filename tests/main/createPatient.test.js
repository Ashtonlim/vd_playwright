...
describe('Patient workflow', () => {
    it('Create and delete a patient', async () => {
        ...
        await page.selectOption(
            'text=Title - Mr. Mrs. Ms. Mdm MISS Dr Prof Master Field Marshall General Lieutenant G >> select',
            'Mr.'
        )
        ...
        await page.selectOption(
            'text=Country Of Birth Select country of birthBangladeshCambodiaChinaIndiaIndonesiaMal >> select',
            'Singapore'
        )
        ...
        await page.click(
            'text=Mobile Number Select region Singapore Indonesia China Cambodia Thailand >> input[type="text"]'
        )
        await page.fill(
            'text=Mobile Number Select region Singapore Indonesia China Cambodia Thailand >> input[type="text"]',
            '+6592812019'
        ...
        await page.selectOption(
            'text=Drug Allergies Select an answer No Known Allergies Yes >> select',
            'No Known Allergies'
        )

        await page.selectOption(
            'text=Food Allergies Select an answer No Known Allergies Yes >> select',
            'No Known Allergies'
        )
